...
class GetUserFollowing extends StatefulWidget {
  final User user;
  GetUserFollowing({this.user});
  @override
  _GetUserFollowingState createState() => _GetUserFollowingState();
}

class _GetUserFollowingState extends State<GetUserFollowing> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white12,
      body: StreamBuilder(
          stream: DatabaseService().getUserFollowing(widget.user.id),
